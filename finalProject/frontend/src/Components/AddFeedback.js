...
function AddFeedback(props){
   ...
   const [cntH, setH]=useState(0)
   const [cntS, setS]=useState(0)
   const [cntC, setC]=useState(0)
   const [cntF, setF]=useState(0)
        ...
        <div className='activState'>
            ...
            <div className='addFeedback'>
                ...
                <div className='reaction'>
                    ...
                    <label>nr reactii: {stare==="desfasurare"?cntH:Object.values(listaReactii)[0]}</label>
                </div>
                <div className='reaction'>
                    <button id="2" onClick={handleClick}><img src='/surprised.png' alt='surprised'></img></button>
                    <label>nr reactii: {stare==="desfasurare"?cntS:Object.values(listaReactii)[1]}</label>
                </div>
                <div className='reaction'>
                    <button id="3" onClick={handleClick}><img src='/confused.png' alt='confused'></img></button>
                    <label>nr reactii: {stare==="desfasurare"?cntC:Object.values(listaReactii)[2]}</label>
                </div>
                <div className='reaction'>
                    <button id="4" onClick={handleClick}><img src='/frowny.png' alt='frowny'></img></button>
                    <label>nr reactii: {stare==="desfasurare"?cntF:Object.values(listaReactii)[3]}</label>
                </div> 
            </div>
            }       
        </div>
